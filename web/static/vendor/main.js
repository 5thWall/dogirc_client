...
Elm.Channel.make = function (_elm) {
   ...
   var channelTab = function (channel) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("ui top attached tabular menu")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("active item")]),
      _L.fromArray([$Html.text(channel.name)]))]));
   };
...
Elm.Main.make = function (_elm) {
   ...
   "Message.Message",
   function (v) {
      return typeof v === "object" && "nick" in v && "message" in v && "kind" in v ? {_: {}
                                                                                     ...
                                                                                     v.message)
                                                                                     ,kind: typeof v.kind === "string" || typeof v.kind === "object" && v.kind instanceof String ? v.kind : _U.badPort("a string",
...
Elm.Message.make = function (_elm) {
   ...
   var view = function (message) {
      return A2($Html.p,
      _L.fromArray([$Html$Attributes.$class(message.kind)]),
